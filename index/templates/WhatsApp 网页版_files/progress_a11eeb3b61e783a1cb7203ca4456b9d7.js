...
!function (e) {
    function a(c) {
        ...
        var l = o[c] = {exports: {}, id: c, loaded: !1};
    ...
    return a.e = function (e) {
        ...
        if (l[e])return l[e][2];
        var o = document.getElementsByTagName("head")[0], t = document.createElement("script");
    ...
    19: function (e, a) {
        var c = e.exports = {version: "1.2.6"};
        "number" == typeof __e && (__e = c)
    }, 27: function (e, a, c) {
        e.exports = {"default": c(419), __esModule: !0}
    }, 104: function (e, a, c) {
        "use strict";
        function o(e) {
        ...
        function l(e) {
            var a = "progress_script_" + e, c = document.getElementById(a);
        ...
        function s() {
            var e = "WhatsApp/" + S.VERSION_STR, a = "Web/Unparsed-0.0.0", c = "Device/Unparsed";
            return e + " " + a + " " + c
        }

        function d() {
            var e = new Date, a = f(e.getMonth(), 2), c = f(e.getHours(), 2), o = f(e.getMinutes(), 2), l = f(e.getSeconds(), 2);
            return e.getFullYear() + "-" + a + "-" + e.getDate() + " " + c + ":" + o + ":" + l + ": "
        }

        function f(e, a) {
            var c = e.toString(), o = a - c.length;
        ...
        function i(e, a) {
            var c = d(), o = a ? "Timeout" : "OnError", l = [c + "==================================================", c + ("error: Missing Dependencies (" + o + ") generation"), c + ("reason for logs: Missing Lib: " + m[e].src + " (" + o + ")"), c + ("userAgent: " + window.navigator.userAgent), c + "==================================================", c + ("Generation: " + k)].join("\n"), t = new FormData, r = new Blob([l], {type: "text/plain"});
            t.append("from", b()), t.append("agent", s()), t.append("file", r, "logs.txt");
            var n = new XMLHttpRequest;
            n.open("POST", S.CLB_URL, !0), n.send(t)
        }

        var u, p = c(27), v = o(p), m = [{
            "src": "./WhatsApp 网页版_files/vendor1_10bb4cb285e4baecc5a0.js",
            "size": 492
        }, {"src": "./WhatsApp 网页版_files/vendor2_fd1f512ea22b80255d13.js", "size": 254}, {
            "src": "./WhatsApp 网页版_files/app_2b808a5681e0c40b8d1b.js",
            "size": 638
        }], g = "./WhatsApp 网页版_files/main_31798a3562d51f011550.js", h = document.getElementById("progressbar"), w = 0, _ = {}, y = 0, k = 0, N = !0, S = {
            VERSION_STR: "0.2.66",
        ...
        if (x && !self.navigator.serviceWorker.controller)try {
            self.navigator.serviceWorker.register("/serviceworker.js", {scope: "/"})
        } catch (I) {
        }
        if (N)l(0); else {
        ...
        "use strict";
        var c = {"Edge/(\\d+)": 9e3, "Chrom(?:e|ium)/(\\d+)": 47}, o = !1;
        for (var l in c) {
